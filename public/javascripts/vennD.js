...
},{"d3-selection":2,"d3-transition":3}],2:[function(require,module,exports){
...
},{"d3-color":4,"d3-dispatch":5,"d3-ease":6,"d3-interpolate":7,"d3-selection":2,"d3-timer":8}],4:[function(require,module,exports){
...
//static
  ...
  function readingExMC(problem){
    ...
    var ansSVG = d3.select('.readingExAns')
                    ...
                    .attr('width', ansW)
                    .attr('height', ansH)
    var barH = ansH/(answers.length*2.5)
    var barW = ansW/2
    // var barH = 10
    var selected
    ansSVG.selectAll('rect')
            ...
            .attr("height", barH)
            .attr("y", function(d,i){
              return i*(ansH/(answers.length+3)) + topMargin
            })
          ...
          .on("mouseover",function(d){
            ...
            d3.select(this).transition().duration(500).attr("width",  barW+barW/2 )
                                        .style('fill','#c4dfe6')
          })
          .on("mouseout",function(d,i){
            if (selected != i){
              d3.select(this).transition().duration(500).attr("width",  barW  )
